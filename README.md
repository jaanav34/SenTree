...
- Synthetic mode: generated by `data/generate_synthetic.py`, producing a 2015-2100 Southeast Asia coastal dataset with temperature, precipitation, GDP, population, soil moisture, and coastal factor grids.
